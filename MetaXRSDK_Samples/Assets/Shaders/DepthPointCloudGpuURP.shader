Shader "TryAR/URP/Depth Point Cloud GPU"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            bool TryReconstructLocalPosition(float2 uv, out float3 localPosition, out float linearDepth)
            {
                localPosition = 0.0;
                linearDepth = 0.0;
                ...
                linearDepth = (1.0 / (ndcDepth + _EnvironmentDepthZBufferParams.y)) * _EnvironmentDepthZBufferParams.x;
            ...
            Varyings Vert(Attributes input)
            {
                ...
                float linearDepth;
                bool isValid = TryReconstructLocalPosition(input.uv, localPosition, linearDepth);
